    ...
    <div className="page-container">
      <div className="page-header">
        ...
        <p className="page-description">
          بعد رفع صور البطاقات سيتم استخراج المعلومات تلقائياً وتحويلها إلى جهات اتصال جاهزة للتصدير
        </p>
        ...
        >
          ...
          {files.length === 0 ? (
            <div className="dropzone-content">
              ...
              <h3>اسحب صور البطاقات هنا لبدء الاستخراج التلقائي</h3>
              <p>أو اضغط لاختيار الملفات من جهازك</p>
              <p className="supported-formats">صور JPG, PNG أو ملفات PDF — يمكنك رفع عدة بطاقات دفعة واحدة</p>
            </div>
          ) : (
